...
<body>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="addBranchModalLabel">Edit Bill</h5>
          ...
          <div class="modal-body">
            <form id="editForm">
              <div class="form-group">
                ...
                <input type="number" class="form-control shadow-blue" id="amount" name="amount" min="0" step="0.01" required>
              </div>

              <div class="form-group">
                <label for="status">Bill Status</label>
                <select class="form-control shadow-blue" id="status" name="status" required>
  ...
  <script>
    ...
    document.addEventListener("DOMContentLoaded", () => {
      fetchData('https://clinicmsys-production.up.railway.app/api/billings');
    });

    function fetchData(url = 'https://clinicmsys-production.up.railway.app/api/billings') {
                ...
                <td>
                    <div class="form-button-action">
                        <button type="button" data-bs-toggle="modal" data-bs-target="#editRowModal"
                            class="btn btn-link btn-primary btn-lg  editbutton" data-item="${item.id}"  data-amount="${item.amount}"  data-status="${item.payment_status}">
    ...
    $(document).ready(function() {
      ...
      $(document).on('click', '.editbutton', function() {
        ...
        const payment_status = $(this).data('status');
        console.log(amount);
      ...
      $('#editForm').on('submit', function(e) {
        ...
        const updatedData = {
          amount: $('#amount').val(),
          payment_status: $('#status').val()
        };

        $.ajax({
          url: `https://clinicmsys-production.up.railway.app/api/billings/${IDToUpdate}`,
